...
ggplot()+theme_bw()+ggtitle('FI-Jok')+
  geom_hline(yintercept = 0)+
  geom_line(data = subset(MMfluxnetdf,MMfluxnetdf$site_id=='FI-Jok'),linetype= 1,
            aes(ts,NEE_CUT_REF, group= site_id, color= "monthlyavg"))+
  geom_line(data = subset(fluxnet.permonth,fluxnet.permonth$site_id=='FI-Jok'),linetype= 4,
            aes(ts,NEE_CUT_REF, group= site_id, color= "monthlyfromdaily"))
```
